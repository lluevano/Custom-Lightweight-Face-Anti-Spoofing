...
#checkpoint = dict(snapshot_name="Micronet_M3_dyshiftmax_CelebA_spoof_CVPR2023_pretrained.pth.tar",
#                  experiment_path='./logs/Micronet_pretrained')
...
#            width_mult = 'M3',
#            pretrained=True,
#            embeding_dim=1280, #unused on micronet
#            imagenet_weights='./models/micronet-m3.pth'
#            )


#checkpoint = dict(snapshot_name="ShuffleNetV2_default_2.0_prelu_celeba_spoof_CVPR2023.pth.tar",
#                  experiment_path='./logs/ShuffleNetV2_default_pretrained')

#model= dict(model_type='ShuffleNetV2_default',
#            model_size = 2.0,
#            width_mult = None,
#            pretrained=False,
#            embeding_dim=2048,
