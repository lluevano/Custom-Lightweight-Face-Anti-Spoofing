...
#Also available on https://github.com/kuangliu/pytorch-cifar/blob/master/models/resnet.py
...
class ResNet(AntiSpoofModel):
    def __init__(self, ResBlock, layer_list, **kwargs):
        ...
        #self.fc = nn.Linear(512*ResBlock.expansion, self.embeding_dim)
