...
#monkey patch collections for attrdict compatibility
import collections
...
class MicroNet(AntiSpoofModel):
    def __init__(self, cfg, input_size=224, activation_name="dyshiftmax", **kwargs):
        ...
        block = DYMicroBlock #eval(cfg.MODEL.MICRONETS.BLOCK)
        stem_mode = "spatialsepsf" #cfg.MODEL.MICRONETS.STEM_MODE
        stem_ch = cfg["stem_ch"]
        ...
        act_max = 2.0 #cfg.MODEL.ACTIVATION.ACT_MAX
        ...
        activation_cfg.INIT_A = cfg["init_a"]
        activation_cfg.INIT_B = cfg["init_b"]

        # building first layer
        assert ((input_size["height"] % 32) == 0) and ((input_size["width"] % 32) == 0)
